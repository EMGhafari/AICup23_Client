...
{
    public class GraphLink3D : MonoBehaviour
    {
        ...
        public void Initialize(Link link, GraphNode3D firstNode, GraphNode3D secondNode)
        {
            _Link = link;
        ...
        /// </summary>
        [SerializeField]
        private GraphNode3D _FirstNode;

        /// <summary>
        /// The first graph node this entity is attached to.
        /// </summary>
        public GraphNode3D FirstNode { get { return _FirstNode; } }
        ...
        /// </summary>
        [SerializeField]
        private GraphNode3D _SecondNode;

        /// <summary>
        /// The second graph node this entity is attached to.
        /// </summary>
        public GraphNode3D SecondNode { get { return _SecondNode; } }
